...
Compress-Archive -Path bin\Release\netcoreapp2.1\win10-x64 -Force -DestinationPath Self-Contained\win10-x64.zip
...
Compress-Archive -Path bin\Release\netcoreapp2.1\osx.10.11-x64 -Force -DestinationPath Self-Contained\osx.10.11-x64.zip
...
Compress-Archive -Path bin\Release\netcoreapp2.1\ubuntu.16.04-x64 -Force -DestinationPath Self-Contained\ubuntu.16.04-x64.zip
...
Compress-Archive -Path bin\Release\netcoreapp2.1\linux-x64 -Force -DestinationPath Self-Contained\linux-x64.zip
